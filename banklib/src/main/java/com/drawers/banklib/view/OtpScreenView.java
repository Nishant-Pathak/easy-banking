 ...
 */
public class OtpScreenView extends BankView implements
        LoadingScreenDialog.Listener,
    ...
    public OtpScreenView(
        ...
        mLoadingScreenDialogTimedOut = new LoadingScreenDialogTimedOut(context, R.style.DialogTheme, this);
    ...
    private void moveToTimedOutState() {
        switch (currentScreenState) {
            case LOADING:
                ...
                break;
            default:
                throw new RuntimeException(String.format("Incorrect state for timeout %1s", currentScreenState));
        }
    }
    ...
    private void throwIncorrectStateTransition(OtpScreenState nextScreenState) {
        throw new RuntimeException(
                String.format("Incorrect state transition from %1s to %2s",
                        currentScreenState,
                        nextScreenState));
    }
    ...
    @Override
    public void resendOtpForLoadingScreen() {
